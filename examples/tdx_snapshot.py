...
from czsc.data.tdx_cache import TdxDataCache
...
dc = TdxDataCache('.', sdt='2010-01-01', edt='2023-12-30')
bars = dc.query_minutes(tdx_code=symbol, freq=freq, sdt=sdt, edt=edt)
c = CZSC(bars)
